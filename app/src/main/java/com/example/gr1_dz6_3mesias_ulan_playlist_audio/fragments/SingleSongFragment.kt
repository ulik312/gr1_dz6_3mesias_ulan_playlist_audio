...
import com.example.gr1_dz6_3mesias_ulan_playlist_audio.databinding.FragmentSingleSongBinding
...
class SingleSongFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvSongTitle.text = arguments?.getString("приятного прослушивания")
    }
}
